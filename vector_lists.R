...
## challenege: in list y, pull out the second and third elements
## in list z, pull out all the transcendental elements
y[2:3]
typeof(z["transcendental"])
z[2]
z$transcendental

## double square bracket, reach into list inside original list
## pepper shaker analogy
...
## map function, apply a function to each element of a vector
## map(vector, function)
library(purrr)
map_dbl(l_doub, exp)
...
## use a map function and a stringr function to split all the fruits that have two words
## in them in their separate character strings
